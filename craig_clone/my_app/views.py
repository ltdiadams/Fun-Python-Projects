...
BASE_LIST_URL = 'https://losangeles.craigslist.org/search/?query={}'
...
def new_search(request):
    ...
    models.Search.objects.create(search=search) # database functionality
    ...
    for post in post_listings:
        ...
        post_url = post.find(class_='result-title').text
