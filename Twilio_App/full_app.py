...
#
sender = # TWILIO NUMBER GIVEN TO YOU
...
# numbers = ['a number', 'another number'] # example numbers to send to
# blacklist = ['some other number'] # numbers we don't want to send to
